...
def controller():
    return boa.load_partial("contracts/Controller.vy").at(
...
@pytest.fixture(scope="module")
def weth():
    return boa.load_partial("contracts/testing/WETH.vy").at(
...
@pytest.fixture(scope="module")
def crvusd():
    return boa.load_partial("contracts/Stablecoin.vy").at(
...
def leverage_zap():
    return boa.load(
        "contracts/zaps/LeverageZap.vy", ["0xcaEC110C784c9DF37240a8Ce096D352A75922DeA"]
    )
