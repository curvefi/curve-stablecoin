...
def test_fee_receiver_flow(controller, factory, admin, collateral_token, borrowed_token, amm):
    """
    ...
    assert borrowed_token.balanceOf(custom_receiver) == initial_balance_custom + collected_2
    ...
    assert borrowed_token.balanceOf(default_receiver) == initial_balance_default + collected_3
