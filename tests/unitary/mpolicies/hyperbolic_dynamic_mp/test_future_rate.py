...
def test_future_rate_matches_reference(mp, controller, default_params, debt, avail, fees):
    ...
    assert mp.future_rate(d_reserves, d_debt) == ref.calculate_rate(params, u, r0)
