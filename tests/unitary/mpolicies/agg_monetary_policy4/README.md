...
- Logs + sequencing: `tests/unitary/controller/test_internal_repay_full.py` captures `filter_logs` immediately after the function call; avoid any extra contract calls in between.
