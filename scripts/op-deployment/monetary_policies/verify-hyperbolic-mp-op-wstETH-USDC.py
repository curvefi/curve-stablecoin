...
Companion to boa-deploy-hyperbolic-mp-op-wstETH-USDC.py, which deploys just the
...
verify-hyperbolic-mp-op-wstETH-USDC.py
"""
...
# ---------------------------------------------------------------------------
# Contract source + curve params (must match boa-deploy-hyperbolic-mp-op-wstETH-USDC.py)
# ---------------------------------------------------------------------------
...
DEFAULT_DEPLOYMENT = "deployments/op/llamalend-op-wstETH-USDC.jsonc"
