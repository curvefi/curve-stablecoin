...
Companion to deploy-hyperbolic-mp-op-wstETH-USDC.py, which deploys just the
...
# ---------------------------------------------------------------------------
# Contract source + curve params (must match deploy-hyperbolic-mp-op-wstETH-USDC.py)
# ---------------------------------------------------------------------------
