...
Reads the deployment report written by
    boa-deploy-llamalend-mainnet-sfrxUSD-crvUSD.py
...
verify-llamalend-mainnet-sfrxUSD-crvUSD.py
"""
...
# ---------------------------------------------------------------------------
# Contract sources (must match boa-deploy-llamalend-mainnet-sfrxUSD-crvUSD.py)
# ---------------------------------------------------------------------------
