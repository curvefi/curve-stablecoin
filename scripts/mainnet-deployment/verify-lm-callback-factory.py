...
Companion to deploy-lm-callback-factory.py: the addresses and the factory's
...
# ---------------------------------------------------------------------------
# Contract sources (must match deploy-lm-callback-factory.py)
# ---------------------------------------------------------------------------
...
DEFAULT_DEPLOYMENT = "deployments/mainnet/lm-callback-factory.jsonc"
