...
CHAINLINK_FEED = "0x524299Ab0987a7c4B3c8022a35669DdcdC715a10" # wstETH / ETH
...
RATE_CALCULATOR = "0x0000000000000000000000000000000000000000"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Deploy LlamaLend wstETH/ETH on OP")
    ...
    parser.add_argument(
        "--report-path",
        default="deployments/llamalend-op-wstETH-ETH.jsonc",
