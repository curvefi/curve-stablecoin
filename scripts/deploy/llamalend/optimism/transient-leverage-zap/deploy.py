...
# LlamaLend V2 lend factory on Optimism (see deployments/llamalend/optimism/factory.jsonc)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Deploy LlamaLend V2 TransientLeverageZapLend on OP"
    )
    ...
    parser.add_argument(
        "--report-path",
        default="deployments/llamalend/optimism/transient-leverage-zap.jsonc",
