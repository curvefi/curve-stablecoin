...
Run:
    ...
    OP_RPC_URL=... python scripts/deploy/llamalend/optimism/monetary_policies/\
wstETH-USDC/deploy.py --dry-run --keystore <path>

    # broadcast
    OP_RPC_URL=... python scripts/deploy/llamalend/optimism/monetary_policies/\
wstETH-USDC/deploy.py --keystore <path>
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--market-deployment",
        default="deployments/llamalend/optimism/markets/wstETH-USDC.jsonc",
