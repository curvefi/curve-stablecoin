...
Run:
    ...
    MAINNET_RPC_URL=... python scripts/deploy/llamalend/ethereum/monetary_policies/\
sfrxUSD-crvUSD/deploy.py --dry-run --account-name <name>

    # broadcast
    MAINNET_RPC_URL=... python scripts/deploy/llamalend/ethereum/monetary_policies/\
sfrxUSD-crvUSD/deploy.py --account-name <name>
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--market-deployment",
        default="deployments/llamalend/ethereum/markets/sfrxUSD-crvUSD.jsonc",
