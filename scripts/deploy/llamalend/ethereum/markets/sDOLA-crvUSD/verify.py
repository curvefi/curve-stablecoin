#!/usr/bin/env python3
"""Verify the sDOLA/crvUSD market's oracle stack, rate calculator, and monetary
...
and submits source + constructor args for each contract that script deploys:
    ...
    4. SDolaRateCalculator     (rate_calculator)
...
DEFAULT_DEPLOYMENT = "deployments/llamalend/ethereum/markets/sDOLA-crvUSD.jsonc"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Verify sDOLA/crvUSD market contracts on Etherscan"
    )
    parser.add_argument(
        "--deployment",
