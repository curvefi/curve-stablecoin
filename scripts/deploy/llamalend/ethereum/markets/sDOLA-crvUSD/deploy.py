...
Run:
    ...
    MAINNET_RPC_URL=... python scripts/deploy/llamalend/ethereum/markets/sDOLA-crvUSD/\
...
# --- Hyperbolic dynamic monetary policy curve ---
...
def main() -> None:
    ...
    parser.add_argument(
        "--report-path",
        default="deployments/llamalend/ethereum/markets/sDOLA-crvUSD.jsonc",
