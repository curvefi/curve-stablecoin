...
AGG_SIGMA = 10**15
ALL_CRVUSD_POOLS = ['0x4DEcE678ceceb27446b35C672dC7d61F30bAD69E', '0x390f3595bCa2Df7d23783dFd126427CCeb997BF4', '0xCa978A0528116DDA3cbA9ACD3e68bc6191CA53D0', '0x34D655069F4cAc1547E4C8cA284FfFF5ad4A8db0']
...
policy_rate = int((1.09**(1 / (365 * 86400)) - 1) * 1e18)  # 9% if PegKeepers are empty, 3.6% when at target fraction
...
def deploy(network):
    ...
    with accounts.use_sender(account):
        ...
        policy = account.deploy(project.AggMonetaryPolicy2, OWNERSHIP_ADMIN, agg, FACTORY,
    ...
    print('Sample rate:       ', policy.rate('0x8472A9A7632b173c8Cf3a86D3afec50c35548e76'))
