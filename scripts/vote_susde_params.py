...
if __name__ == '__main__':
    ...
    actions = [
        (mpolicy.at(MPOLICY), 'set_parameters', target_util, low_ratio, high_ratio, rate_shift)
    ]
    ...
    if '--fork' in sys.argv[1:]:
        ...
        print(mpolicy.rate("0xB536FEa3a01c95Dd09932440eC802A75410139D6") * 365 * 86400 / 1e18)
